...
<body>
    ...
    <div class="header" id="myHeader" >
            <nav class="navbar  navbar-expand-md navbar-light bg-white shadow-sm justify-content-start">
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar">
                <span class="navbar-toggler-icon"></span>
            </button>
            <!--logo-->
            <a class="navbar-brand" href="#"><img src="{{asset('image/logof.png')}}" alt="logo" style="width:80px;" >
            <span class="cname">CVENT</span></a>
